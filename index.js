...
function getVariableType(variable) {
  ...
  switch (typeof (variable)) {
    case 'number': resType = 'Це число';
      break;
    case 'string': resType = 'Це рядок';
      break;
     case 'boolean': resType = 'Це булеве значення';
      break;
    default: resType = 'Це інший тип'
  }
  return resType
...
// не дуже розумію, як працює, але знайшла таке рішення в google
